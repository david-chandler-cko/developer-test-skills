...
| [`dotnet-developer-tests`](dotnet-developer-tests/SKILL.md) | .NET scaffolder: creates `*.Developer.Tests` projects, scenarios, fakes, and `httpclient-interception` setup. Defers to `outside-in-testing` for the "why". |
